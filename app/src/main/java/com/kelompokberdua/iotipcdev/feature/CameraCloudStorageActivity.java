...
public class CameraCloudStorageActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        timeAdapter = new CameraVideoTimerAdapter(this, timePieceBeans);
        timeRv.setAdapter(timeAdapter);
        IPCSavePathUtils ipcSavePathUtils = new IPCSavePathUtils(this);
        timeAdapter.setListener(new CameraVideoTimerAdapter.OnTimeItemListener() {
            @Override
            ...
            public void onLongClick(TimePieceBean o) {
                boolean open_storage = Constant.requestPermission(CameraCloudStorageActivity.this,
                        Manifest.permission.WRITE_EXTERNAL_STORAGE, Constant.EXTERNAL_STORAGE_REQ_CODE, "open_storage");
                if (open_storage) {
