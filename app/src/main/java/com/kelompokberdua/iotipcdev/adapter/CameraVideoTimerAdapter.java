...
public class CameraVideoTimerAdapter extends RecyclerView.Adapter<CameraVideoTimerAdapter.MyViewHolder> {
    private LayoutInflater mInflater;
    private List<TimePieceBean> timePieceBeans;
    private OnTimeItemListener listener;

    public CameraVideoTimerAdapter(Context context, List<TimePieceBean> timePieceBeans) {
